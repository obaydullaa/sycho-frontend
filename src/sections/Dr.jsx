...
export default function Dr() {
  return (
    <>
      {/* <!--======== dr area start ========--> */}
      <section className="dr-area" data-background="assets/img/bg/features-bg.jpg"> 
          <div className="container">
              <div className="row">
                  <div className="col-lg-5">
                      <div className="dr-image">
                          <img src="assets/img/bg/sychologist-person.png" alt=""/>
                      </div>
                  </div>
                  <div className="col-lg-7">
                      <div className="dr-content">
                          <h2>Dr Noorie Abbas</h2>
                          <h4 className="mb-20">Psychotherapist, Medinova Hospital in California</h4>
                      ...
                      <div className="sign-dr">
                          <button type='button' className="sy-btn mb-30">get appointment</button>
                          <img className="ml-20" src="assets/img/icon/signature.png" alt=""/>
                      </div>
                  </div>
              </div>
          </div>
